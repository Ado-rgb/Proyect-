...
module.exports = async (msg, { conn, args }) => {
  try {
    ...
    if (rpgData.usuarios[userId]) {
      await conn.sendMessage(msg.key.remoteJid, {
        text: `⚠️ *Ya estás registrado en el gremio Sya Team*\n\n📜 Usa *${global.prefix}menurpg* para ver tus opciones`
      }, { quoted: msg });
      return;
    }

    await conn.sendMessage(msg.key.remoteJid, { react: { text: "⏳", key: msg.key } });
    let registroMensaje = await conn.sendMessage(msg.key.remoteJid, { text: `📝 *Registrando en el Gremio Sya Team...*` }, { quoted: msg });
...
🚀 *¡Prepárate para la aventura en Sya Team!* 🏆`;
