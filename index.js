(async () => {
let canalId = ["120363402846939411@newsletter"];  
let canalNombre = ["🔥 SYA TEAM CHANNEL 💥"]
...
try {
  ...
  if (isGroup && chatgptActivo && !fromMe && messageText.length > 0) {
    ...
    const apiUrl = `https://api.neoxr.eu/api/gpt4-session?q=${encodedText}&session=${sessionID}&apikey=GataDios`;
